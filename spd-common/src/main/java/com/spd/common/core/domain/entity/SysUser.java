package com.spd.common.core.domain.entity;
...
public class SysUser extends BaseEntity
{
    ...
    /**
     * 首页设置授权 keys（逗号分隔）：simple=默认，full=完整，purchase=采购，warehouse=库房，department=科室；空/未配置时前端默认显示「默认」首页
     */
