...
CREATE TABLE IF NOT EXISTS `stk_initial_import_entry` (
  ...
  `bill_no` varchar(64) DEFAULT NULL COMMENT '期初单号（冗余主表 bill_no）',
...
CREATE TABLE IF NOT EXISTS `bas_apply_template_entry` (
  ...
  `material_id` bigint(20) NOT NULL COMMENT '耗材ID',
  `qty` decimal(18,6) NOT NULL DEFAULT 1.00 COMMENT '数量',
  `sort_order` int(11) DEFAULT 0 COMMENT '排序',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE IF NOT EXISTS `fin_invoice` (
  ...
  `total_amount` decimal(18,6) DEFAULT NULL COMMENT '价税合计',
...
CREATE TABLE IF NOT EXISTS `wh_settlement_bill_entry` (
  ...
  `qty` decimal(18,6) NOT NULL DEFAULT 0.00 COMMENT '数量',
...
CREATE TABLE IF NOT EXISTS `dep_purchase_apply_entry` (
  ...
  `line_void_qty` decimal(18,6) NOT NULL DEFAULT 0 COMMENT '累计作废数量',
...
CREATE TABLE IF NOT EXISTS `dep_pur_apply_ck_entry_ref` (
  ...
  `ref_qty` decimal(18,6) NOT NULL COMMENT '本行关联数量',
  `ref_amt` decimal(18,6) DEFAULT NULL COMMENT '关联金额快照',
...
CREATE TABLE IF NOT EXISTS `purchase_plan_entry_apply` (
  ...
  `apply_bill_no` varchar(64) DEFAULT NULL COMMENT '科室申领单号',
...
CREATE TABLE IF NOT EXISTS `dep_purchase_apply_agg_entry` (
  ...
  `purchase_bill_no` varchar(64) DEFAULT NULL COMMENT '汇总申购单号（冗余主表 purchase_bill_no）',
  `tenant_id` varchar(36) DEFAULT NULL COMMENT '租户ID',
  `material_id` bigint DEFAULT NULL COMMENT '耗材ID',
  ...
  `unit` varchar(64) DEFAULT NULL COMMENT '单位',
  `unit_price` decimal(18,6) DEFAULT NULL COMMENT '单价',
  `qty` decimal(18,6) DEFAULT NULL COMMENT '申购数量',
  `amt` decimal(18,6) DEFAULT NULL COMMENT '金额',
  `reason` varchar(500) DEFAULT NULL COMMENT '申购理由',
...
CREATE TABLE IF NOT EXISTS `gz_dep_apply_entry` (
  ...
  `apply_bill_no` varchar(64) DEFAULT NULL COMMENT '申领单号（冗余主表 apply_bill_no）',
  `material_id` bigint DEFAULT NULL COMMENT '耗材ID',
  `unit_price` decimal(18,6) DEFAULT NULL COMMENT '单价',
...
CREATE TABLE IF NOT EXISTS `gz_traceability_entry` (
  ...
  `trace_no` varchar(64) DEFAULT NULL COMMENT '追溯单号（冗余主表 trace_no）',
  `material_id` bigint DEFAULT NULL COMMENT '耗材ID',
...
CREATE TABLE IF NOT EXISTS `hc_doc_bill_ref` (
  ...
  `ref_amt` decimal(18,6) DEFAULT NULL COMMENT '本次引用金额快照',
...
CREATE TABLE IF NOT EXISTS `t_hc_ck_flow` (
  ...
  `qty` decimal(18,6) DEFAULT 0.00 COMMENT '数量',
  `unit_price` decimal(18,6) DEFAULT NULL COMMENT '单价',
  `amt` decimal(18,6) DEFAULT NULL COMMENT '金额',
  `begin_time` date DEFAULT NULL COMMENT '生产日期',
  `end_time` date DEFAULT NULL COMMENT '有效期',
...
CREATE TABLE IF NOT EXISTS `stk_profit_loss_pending` (
  ...
  `batch_id` bigint DEFAULT NULL COMMENT '批次对象表ID（stk_batch.id）',
  `batch_number` varchar(100) DEFAULT NULL COMMENT '批号',
  `qty` decimal(18,6) DEFAULT NULL COMMENT '待入账数量',
  `unit_price` decimal(18,6) DEFAULT NULL COMMENT '单价',
  `amt` decimal(18,6) DEFAULT NULL COMMENT '金额',
  `begin_time` date DEFAULT NULL COMMENT '生产日期',
  `end_time` date DEFAULT NULL COMMENT '有效期',
...
CREATE TABLE IF NOT EXISTS `stk_io_stocktaking_entry` (
  ...
  `material_id` bigint DEFAULT NULL COMMENT '耗材ID',
  `unit_price` decimal(18,6) DEFAULT NULL COMMENT '单价',
  `qty` decimal(18,6) DEFAULT NULL COMMENT '账目数量',
  `price` decimal(18,6) DEFAULT NULL COMMENT '价格',
  `amt` decimal(18,6) DEFAULT NULL COMMENT '金额',
  `batch_no` varchar(100) DEFAULT NULL COMMENT '批次号',
  ...
  `del_flag` int NOT NULL DEFAULT 0 COMMENT '删除标志',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  `stock_qty` decimal(18,6) DEFAULT NULL COMMENT '实盘数量',
  `profit_qty` decimal(18,6) DEFAULT NULL COMMENT '盈亏数量',
  `profit_loss_flag` varchar(16) DEFAULT NULL COMMENT '盈亏标志(PROFIT/LOSS/EQUAL)',
  `stock_amount` decimal(18,6) DEFAULT NULL COMMENT '盘点金额',
  `profit_amount` decimal(18,6) DEFAULT NULL COMMENT '盈亏金额',
  `main_barcode` varchar(128) DEFAULT NULL COMMENT '高值主条码',
  `sub_barcode` varchar(128) DEFAULT NULL COMMENT '高值辅条码',
...
CREATE TABLE IF NOT EXISTS `stk_io_profit_loss_entry` (
  ...
  `bill_no` varchar(64) DEFAULT NULL COMMENT '盈亏单号（冗余主表 bill_no）',
  ...
  `book_qty` decimal(18,6) DEFAULT NULL COMMENT '账面数量',
  `stock_qty` decimal(18,6) DEFAULT NULL COMMENT '盘点数量',
  `profit_qty` decimal(18,6) DEFAULT NULL COMMENT '盈亏数量',
  `unit_price` decimal(18,6) DEFAULT NULL COMMENT '单价',
  `profit_amount` decimal(18,6) DEFAULT NULL COMMENT '盈亏金额',
  `begin_time` date DEFAULT NULL COMMENT '生产日期',
...
CREATE TABLE IF NOT EXISTS `t_hc_ks_xh_entry` (
  ...
  `unit_price` decimal(18,6) DEFAULT 0.00 COMMENT '单价',
  `qty` decimal(18,6) DEFAULT 0.00 COMMENT '数量',
  `price` decimal(18,6) DEFAULT 0.00 COMMENT '价格',
  `amt` decimal(18,6) DEFAULT 0.00 COMMENT '金额',
  `batch_no` varchar(100) DEFAULT NULL COMMENT '批次号',
  `batch_number` varchar(100) DEFAULT NULL COMMENT '批号',
  ...
  `src_consume_qty` decimal(18,6) DEFAULT NULL COMMENT '正向消耗数量快照',
  `src_can_reverse_qty` decimal(18,6) DEFAULT NULL COMMENT '反消耗生成时可退数量快照',
  `create_by` varchar(64) DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_by` varchar(64) DEFAULT '' COMMENT '更新者',
  `update_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE IF NOT EXISTS `t_hc_ks_xh_entry_ref` (
  ...
  `supplier_id` varchar(128) DEFAULT NULL COMMENT '供应商ID',
  `factory_id` bigint DEFAULT NULL COMMENT '生产厂家ID',
  `out_entry_qty` decimal(18,6) DEFAULT NULL COMMENT '来源出库明细数量',
  `available_qty` decimal(18,6) DEFAULT NULL COMMENT '库存剩余数量（引用时）',
  `default_consume_qty` decimal(18,6) DEFAULT NULL COMMENT '默认带出数量（min(库存剩余,出库明细数量)）',
  `consume_qty` decimal(18,6) DEFAULT NULL COMMENT '本次消耗数量',
  `unit_price` decimal(18,6) DEFAULT NULL COMMENT '单价',
  `amount` decimal(18,6) DEFAULT NULL COMMENT '金额',
  `main_barcode` varchar(128) DEFAULT NULL COMMENT '主条码',
  `sub_barcode` varchar(128) DEFAULT NULL COMMENT '辅条码',
...
CREATE TABLE IF NOT EXISTS `wh_warehouse_apply` (
  ...
  `void_whole_time` datetime DEFAULT NULL COMMENT '整单作废时间',
  `void_whole_reason` varchar(500) DEFAULT NULL COMMENT '整单作废原因',
  `total_qty` decimal(18,6) DEFAULT NULL COMMENT '明细数量合计',
  `total_amt` decimal(18,6) DEFAULT NULL COMMENT '明细金额合计',
...
CREATE TABLE IF NOT EXISTS `wh_warehouse_apply_entry` (
  ...
  `unit_price` decimal(18,6) DEFAULT NULL COMMENT '单价（按拆分时的库存行）',
  `qty` decimal(18,6) DEFAULT NULL COMMENT '数量',
  `price` decimal(18,6) DEFAULT NULL COMMENT '价格',
  `amt` decimal(18,6) DEFAULT NULL COMMENT '金额',
  `batch_no` varchar(100) DEFAULT NULL COMMENT '入库批次号',
  ...
  `factory_id` bigint DEFAULT NULL COMMENT '生产厂家ID',
  `line_void_status` int NOT NULL DEFAULT 0 COMMENT '明细作废状态：0正常 1已作废',
  `line_void_qty` decimal(18,6) NOT NULL DEFAULT 0.00 COMMENT '累计作废数量',
...
-- ========== 采购/申领（若依遗留主表 + SPD 扩展；新开户全量建表须含明细单号冗余列） ==========
CREATE TABLE IF NOT EXISTS `purchase_order` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `order_no` varchar(64) DEFAULT NULL COMMENT '订单单号',
  `plan_no` varchar(64) DEFAULT NULL COMMENT '计划单号',
  `plan_id` bigint(20) DEFAULT NULL COMMENT '计划单主表ID',
  `order_date` datetime DEFAULT NULL COMMENT '订单时间',
  `supplier_id` bigint(20) DEFAULT NULL COMMENT '供应商ID',
  `warehouse_id` bigint(20) DEFAULT NULL COMMENT '仓库ID',
  `is_gz` char(1) DEFAULT NULL COMMENT '高低值 1高值 2低值',
  `department_id` bigint(20) DEFAULT NULL COMMENT '科室ID',
  `order_status` char(1) DEFAULT '0' COMMENT '订单状态',
  `order_type` char(1) DEFAULT '1' COMMENT '订单类型',
  `urgency_level` char(1) DEFAULT '2' COMMENT '紧急程度',
  `total_amount` decimal(18,6) DEFAULT 0.000000 COMMENT '总金额',
  `paid_amount` decimal(18,6) DEFAULT NULL COMMENT '已付金额',
  `unpaid_amount` decimal(18,6) DEFAULT NULL COMMENT '未付金额',
  ...
  `scm_order_id` bigint(20) DEFAULT NULL COMMENT '平台订单主键',
  `scm_order_no` varchar(64) DEFAULT NULL COMMENT '平台订单编号',
  `push_status` char(1) DEFAULT '0' COMMENT '推送状态',
  `push_time` datetime DEFAULT NULL COMMENT '推送时间',
  `push_error_msg` varchar(500) DEFAULT NULL COMMENT '推送失败原因',
  `scm_hospital_code` varchar(64) DEFAULT NULL COMMENT '平台医院编码快照',
  `scm_supplier_code` varchar(64) DEFAULT NULL COMMENT '平台供应商编码快照',
  `push_by` varchar(64) DEFAULT NULL COMMENT '发布人',
  `void_whole_flag` int DEFAULT 0 COMMENT '整单作废',
  `void_whole_by` varchar(64) DEFAULT NULL COMMENT '作废人',
  `void_whole_time` datetime DEFAULT NULL COMMENT '作废时间',
  `void_whole_reason` varchar(500) DEFAULT NULL COMMENT '作废原因',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  `del_flag` char(1) DEFAULT '0' COMMENT '删除标志',
  `delete_by` varchar(64) DEFAULT NULL COMMENT '删除者',
  `delete_time` datetime DEFAULT NULL COMMENT '删除时间',
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_purchase_order_no` (`order_no`),
...
CREATE TABLE IF NOT EXISTS `purchase_order_entry` (
  ...
  `order_no` varchar(64) DEFAULT NULL COMMENT '订单单号（冗余主表 order_no）',
  `material_id` bigint(20) NOT NULL COMMENT '耗材ID',
  `material_code` varchar(64) DEFAULT NULL COMMENT '耗材编码',
  `material_name` varchar(200) DEFAULT NULL COMMENT '耗材名称',
  `material_spec` varchar(200) DEFAULT NULL COMMENT '规格',
  `material_unit` varchar(64) DEFAULT NULL COMMENT '单位',
  `order_qty` decimal(18,6) DEFAULT NULL COMMENT '订单数量',
  `received_qty` decimal(18,6) DEFAULT 0 COMMENT '已收货数量',
  `unit_price` decimal(18,6) DEFAULT NULL COMMENT '单价',
  `total_amount` decimal(18,6) DEFAULT NULL COMMENT '金额',
  `expected_delivery_date` date DEFAULT NULL COMMENT '预期交货日期',
  `actual_delivery_date` date DEFAULT NULL COMMENT '实际交货日期',
  `quality_status` char(1) DEFAULT '0' COMMENT '质量状态',
  `plan_id` bigint(20) DEFAULT NULL COMMENT '计划单主表ID',
  `plan_no` varchar(64) DEFAULT NULL COMMENT '计划单号',
  `plan_entry_id` bigint(20) DEFAULT NULL COMMENT '计划单明细ID',
  `scm_order_detail_id` bigint(20) DEFAULT NULL COMMENT '平台订单明细ID',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  `del_flag` char(1) DEFAULT '0' COMMENT '删除标志',
  `delete_by` varchar(64) DEFAULT NULL COMMENT '删除者',
  `delete_time` datetime DEFAULT NULL COMMENT '删除时间',
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_poe_parent` (`parent_id`),
  KEY `idx_poe_order_no` (`order_no`),
  KEY `idx_poe_tenant` (`tenant_id`)
...
CREATE TABLE IF NOT EXISTS `purchase_plan` (
  ...
  `supplier_id` bigint(20) DEFAULT NULL COMMENT '供应商ID',
  `warehouse_id` bigint(20) DEFAULT NULL COMMENT '仓库ID',
  `is_gz` char(1) DEFAULT NULL COMMENT '高低值',
  `department_id` bigint(20) DEFAULT NULL COMMENT '科室ID',
  `plan_date` date DEFAULT NULL COMMENT '计划日期',
  `plan_status` char(1) DEFAULT '0' COMMENT '计划状态',
  `plan_entry_mode` varchar(20) DEFAULT '1' COMMENT '明细生成方式',
  `total_amount` decimal(18,6) DEFAULT NULL COMMENT '总金额',
  `audit_by` varchar(64) DEFAULT NULL COMMENT '审核人',
  `audit_date` datetime DEFAULT NULL COMMENT '审核时间',
  `audit_opinion` varchar(500) DEFAULT NULL COMMENT '审核意见',
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_purchase_plan_no` (`plan_no`),
  KEY `idx_purchase_plan_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='采购计划主表';
/
CREATE TABLE IF NOT EXISTS `purchase_plan_entry` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `parent_id` bigint(20) NOT NULL COMMENT '主表ID',
  `plan_no` varchar(64) DEFAULT NULL COMMENT '计划单号（冗余主表 plan_no）',
  `material_id` bigint(20) NOT NULL COMMENT '耗材ID',
  `supplier_id` bigint(20) DEFAULT NULL COMMENT '供应商ID',
  `qty` decimal(18,6) DEFAULT NULL COMMENT '计划数量',
  `apply_qty` decimal(18,6) DEFAULT NULL COMMENT '申购数量',
  `price` decimal(18,6) DEFAULT NULL COMMENT '单价',
  `amt` decimal(18,6) DEFAULT NULL COMMENT '金额',
  `speci` varchar(200) DEFAULT NULL COMMENT '规格',
  `model` varchar(200) DEFAULT NULL COMMENT '型号',
  `apply_department_id` bigint(20) DEFAULT NULL COMMENT '申请科室ID',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  `del_flag` char(1) DEFAULT '0' COMMENT '删除标志',
  `delete_by` varchar(64) DEFAULT NULL COMMENT '删除者',
  `delete_time` datetime DEFAULT NULL COMMENT '删除时间',
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_ppe_parent` (`parent_id`),
  KEY `idx_ppe_plan_no` (`plan_no`),
  KEY `idx_ppe_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='采购计划明细表';
/
CREATE TABLE IF NOT EXISTS `bas_apply` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `apply_bill_no` varchar(64) DEFAULT NULL COMMENT '申领单号',
  `apply_bill_date` date DEFAULT NULL COMMENT '申请日期',
  `warehouse_id` bigint(20) DEFAULT NULL COMMENT '仓库ID',
  `department_id` bigint(20) DEFAULT NULL COMMENT '科室ID',
  `user_id` bigint(20) DEFAULT NULL COMMENT '操作人ID',
  `apply_bill_status` int DEFAULT NULL COMMENT '申请状态',
  `bill_type` int DEFAULT NULL COMMENT '单据类型',
  `audit_by` varchar(64) DEFAULT NULL COMMENT '审核人',
  `audit_date` datetime DEFAULT NULL COMMENT '审核时间',
  `reject_reason` varchar(500) DEFAULT NULL COMMENT '驳回原因',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_bas_apply_no` (`apply_bill_no`),
  KEY `idx_bas_apply_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='科室申领主表';
/
CREATE TABLE IF NOT EXISTS `bas_apply_entry` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `paren_id` bigint(20) NOT NULL COMMENT '主表ID',
  `apply_bill_no` varchar(64) DEFAULT NULL COMMENT '申领单号（冗余主表 apply_bill_no）',
  `material_id` bigint(20) DEFAULT NULL COMMENT '耗材ID',
  `stock_warehouse_id` bigint(20) DEFAULT NULL COMMENT '可用库存仓库ID',
  `unit_price` decimal(18,6) DEFAULT NULL COMMENT '单价',
  `qty` decimal(18,6) DEFAULT NULL COMMENT '数量',
  `price` decimal(18,6) DEFAULT NULL COMMENT '价格',
  `amt` decimal(18,6) DEFAULT NULL COMMENT '金额',
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_bas_apply_entry_paren` (`paren_id`),
  KEY `idx_bas_apply_entry_no` (`apply_bill_no`),
  KEY `idx_bas_apply_entry_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='科室申领明细表';
/
CREATE TABLE IF NOT EXISTS `new_product_apply` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `apply_no` varchar(64) DEFAULT NULL COMMENT '申购单号',
  `apply_date` date DEFAULT NULL COMMENT '申请日期',
  `department_id` bigint(20) DEFAULT NULL COMMENT '科室ID',
  `user_id` bigint(20) DEFAULT NULL COMMENT '申请人ID',
  `apply_status` int DEFAULT NULL COMMENT '申请状态',
  `total_amount` decimal(18,6) DEFAULT NULL COMMENT '总金额',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  `del_flag` int DEFAULT 0 COMMENT '删除标志',
  `delete_by` varchar(64) DEFAULT NULL COMMENT '删除者',
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_new_product_apply_no` (`apply_no`),
  KEY `idx_new_product_apply_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='新品申购主表';
/
CREATE TABLE IF NOT EXISTS `new_product_apply_entry` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `parent_id` bigint(20) NOT NULL COMMENT '主表ID',
  `apply_no` varchar(64) DEFAULT NULL COMMENT '申购单号（冗余主表 apply_no）',
  `material_id` bigint(20) DEFAULT NULL COMMENT '耗材ID',
  `material_name` varchar(200) DEFAULT NULL COMMENT '耗材名称',
  `speci` varchar(200) DEFAULT NULL COMMENT '规格',
  `model` varchar(200) DEFAULT NULL COMMENT '型号',
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_npa_entry_parent` (`parent_id`),
  KEY `idx_npa_entry_no` (`apply_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='新品申购明细表';
/
CREATE TABLE IF NOT EXISTS `new_product_apply_detail` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `parent_id` bigint(20) NOT NULL COMMENT '主表ID',
  `apply_no` varchar(64) DEFAULT NULL COMMENT '申购单号（冗余主表 apply_no）',
  `entry_id` bigint(20) DEFAULT NULL COMMENT '明细ID',
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `idx_npa_detail_parent` (`parent_id`),
  KEY `idx_npa_detail_no` (`apply_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='新品申购扩展明细表';
/
...
CREATE TABLE IF NOT EXISTS `purchase_forecast_entry` (
  ...
  `task_no` varchar(64) DEFAULT NULL COMMENT '预测任务号（冗余 purchase_forecast_task.task_no）',
  `warehouse_id` bigint(20) NOT NULL COMMENT '仓库ID',
  `material_id` bigint(20) NOT NULL COMMENT '耗材ID',
