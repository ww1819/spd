...
public class SbWorkGroupController extends BaseController {
  ...
  @PreAuthorize("@ss.hasPermi('sb:system:workgroup:list') or @ss.isPlatformUser() or @ss.isTenantUserWithCustomer(#customerId)")
  @GetMapping("/list")
  ...
  @PreAuthorize("@ss.hasPermi('sb:system:workgroup:query') or @ss.isPlatformUser() or @ss.isTenantUserWithGroup(#groupId)")
  @GetMapping("/{groupId}")
  ...
  @PreAuthorize("@ss.hasPermi('sb:system:workgroup:remove') or @ss.isPlatformUser() or @ss.isTenantUserWithGroup(#groupId)")
  ...
  @PreAuthorize("@ss.hasPermi('sb:system:workgroup:edit') or @ss.isPlatformUser() or @ss.isTenantUserWithGroup(#groupId)")
  ...
  /** 工作组可分配的菜单树（客户已开启的菜单） */
  @PreAuthorize("@ss.hasPermi('sb:system:workgroup:query') or @ss.isPlatformUser() or @ss.isTenantUserWithCustomer(#customerId)")
  @GetMapping("/menuTree")
