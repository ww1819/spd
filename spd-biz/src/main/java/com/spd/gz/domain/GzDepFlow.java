...
public class GzDepFlow {
    ...
    private String gzDepInventoryId;
    ...
    public String getGzDepInventoryId() { return gzDepInventoryId; }
    public void setGzDepInventoryId(String gzDepInventoryId) { this.gzDepInventoryId = gzDepInventoryId; }
