...
public class GzWhFlow {
    ...
    private String gzDepotInventoryId;
    ...
    public String getGzDepotInventoryId() { return gzDepotInventoryId; }
    public void setGzDepotInventoryId(String gzDepotInventoryId) { this.gzDepotInventoryId = gzDepotInventoryId; }
