...
public class GzOrderController extends BaseController
{
    ...
    @Log(title = "高值备货入库", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    ...
    @Log(title = "高值备货入库", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "高值备货入库", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "高值备货入库", businessType = BusinessType.DELETE)
	@DeleteMapping("/{ids}")
