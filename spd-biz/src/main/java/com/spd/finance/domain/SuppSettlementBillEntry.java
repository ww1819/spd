...
/**
 * 供应商结算单明细表 supp_settlement_bill_entry
 * 主键UUID7，可追溯仓库结算单明细
 */
public class SuppSettlementBillEntry {
    ...
    /** 仓库结算单单号 */
    private String whSettlementBillNo;
    /** 仓库结算单明细ID（追溯） */
    private String whSettlementEntryId;
    ...
    public String getWhSettlementBillNo() { return whSettlementBillNo; }
    public void setWhSettlementBillNo(String whSettlementBillNo) { this.whSettlementBillNo = whSettlementBillNo; }
    public String getWhSettlementEntryId() { return whSettlementEntryId; }
    public void setWhSettlementEntryId(String whSettlementEntryId) { this.whSettlementEntryId = whSettlementEntryId; }
