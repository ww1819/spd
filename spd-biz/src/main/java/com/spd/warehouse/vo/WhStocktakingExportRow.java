...
/**
 * 仓库盘点导出行（主单字段 + 一条明细，多明细多行）
 */
public class WhStocktakingExportRow implements Serializable {
    ...
    @Excel(name = "账面数量", width = 12)
    private BigDecimal bookQty;

    @Excel(name = "实盘数量", width = 12)
    ...
    @Excel(name = "第三方库存明细ID", width = 22)
    private String hisId;

    @Excel(name = "第三方批次号", width = 20)
